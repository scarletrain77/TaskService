var Main = (function (_super) {
    ...
    p.createGameScene = function () {
        ...
        var NPC1 = new NPC("npc_0", "NPC1_png", NPC1x, NPC1y, "get task");
        var NPC2 = new NPC("npc_1", "NPC2_png", NPC2x, NPC2y, "finish task");
        var task = new Task("000", "task1", "test for the task", "npc_0", "npc_1");
