var Main = (function (_super) {
    ...
    p.createGameScene = function () {
        ...
        var NPC2x = 400;
        var NPC2y = 300;
        var task = new Task("000", "task1", "test for the task", "NPC1", "NPC2");
        var dialogPanel1 = new DialogPanel();
        var dialogPanel2 = new DialogPanel();
        var NPC1 = new NPC("NPC1", "NPC1_png", NPC1x, NPC1y, dialogPanel1);
        NPC1.init();
        var NPC2 = new NPC("NPC2", "NPC2_png", NPC2x, NPC2y, dialogPanel2);
        NPC2.init();
        TaskService.getInstance().addTask(task);
        var taskPanel = new TaskPanel(100, 100);
